...
__all__ = ["TestSetuptoolsExample"]


@pytest.mark.regression
class TestSetuptoolsExample:
    """
    ...
    def test_example_build_and_execution(self, tmp_path: Path) -> None:
        ...
        temp_dir = tmp_path / "setuptools_example"
        temp_dir.mkdir()
        ...
        repo.add(".gitignore")
        repo.add("README.md")
        repo.add("src/setuptools_example/__init__.py")
        repo.add("src/setuptools_example/main.py")
        ...
        with zipfile.ZipFile(wheels[0]) as zip_file:
            ...
            version_file = "setuptools_example/version.py"
        ...
        run_result = subprocess.run(
            [sys.executable, "-m", "setuptools_example.main"],
            cwd=temp_dir / "src",
            capture_output=True,
            text=True,
            check=False,
