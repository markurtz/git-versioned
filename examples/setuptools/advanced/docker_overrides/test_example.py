...
"""
Automated regression test verifying Setuptools integration with Dockerfile overrides.
"""
...
__all__ = ["TestSetuptoolsDockerOverridesExample"]


@pytest.mark.regression
class TestSetuptoolsDockerOverridesExample:
    """
    ...
    def test_example_build_and_overrides(self, tmp_path: Path) -> None:
        ...
        temp_dir = tmp_path / "setuptools_docker_overrides"
        temp_dir.mkdir()
        ...
        repo.add(".gitignore")
        repo.add("README.md")
        repo.add("src/setuptools_docker_overrides/__init__.py")
        repo.add("src/setuptools_docker_overrides/main.py")
        ...
        with zipfile.ZipFile(wheels[0]) as zip_file:
            ...
            version_file = "setuptools_docker_overrides/version.py"
