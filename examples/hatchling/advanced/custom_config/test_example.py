...
"""
Automated regression test verifying Hatchling integration with custom configurations.
"""
...
__all__ = ["TestHatchlingCustomConfigExample"]


@pytest.mark.regression
class TestHatchlingCustomConfigExample:
    """
    ...
    def test_example_build_and_custom_config(self, tmp_path: Path) -> None:
        ...
        temp_dir = tmp_path / "hatchling_custom_config"
        temp_dir.mkdir()
        ...
        repo.add(".gitignore")
        repo.add("README.md")
        repo.add("src/hatchling_custom_config/__init__.py")
        repo.add("src/hatchling_custom_config/main.py")
        ...
        with zipfile.ZipFile(wheels[0]) as zip_file:
            ...
            version_file = "hatchling_custom_config/version.py"
