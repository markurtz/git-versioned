...
"""
Main entrypoint orchestration for the Maturin minimal example.
"""
...
from maturin_example import __version__

try:
    import maturin_example as rust_lib
except ImportError:
    rust_lib = None
...
def run_example() -> None:
    ...
    """
    sys.stdout.write(f"Maturin Example Version: {__version__}\n")
