...
def test_psutil(
    ...
    if is_available:
        ...
        monkeypatch.setitem(sys.modules, "psutil", typing.cast("typing.Any", None))
...
def test_tomllib(
    ...
    if tomllib_available:
        ...
        monkeypatch.setitem(sys.modules, "tomllib", typing.cast("typing.Any", None))

    if tomli_available:
        mock_tomli = types.ModuleType("tomli")
        monkeypatch.setitem(sys.modules, "tomli", mock_tomli)
    else:
        monkeypatch.setitem(sys.modules, "tomli", typing.cast("typing.Any", None))
